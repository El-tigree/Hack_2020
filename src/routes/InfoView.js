    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Paper style={{background: "linear-gradient(#002b90, #006bc6)", height: '342px', width: '1120px', marginLeft: '24px', marginTop: '24px'}}>
			...
			<div>
				<Button
					style={{width: 310, borderRadius: 24}}
				...
				<Button 
				style={{marginLeft: '32px', borderRadius: 24, width: 310, backgroundColor: '#0033aa', color: '#fff'}}
					variant="contained" color="primary" onClick={() => history.push('/calculator')}>
					proceed
				</Button>
				</div>
              </CardContent>
